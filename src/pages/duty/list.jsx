...
import { DutyListColumns } from 'src/features/columns';
...
export default function DutyListPage() {
  ...
  const { data, error, isLoading } = useDutyListQuery({ page, limit, title });
  ...
  const toolbar = {
    ...
    redirect: { label: 'New Duty', path: '/dashboard/duty/create' },
  };
